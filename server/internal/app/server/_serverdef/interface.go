...
type HTTPAPIHandler interface {
	...
	SetSecret(w http.ResponseWriter, req *http.Request)
	// oauth
	ListOAuthProviders(w http.ResponseWriter, req *http.Request)
	...
	SetOAuthConfig(w http.ResponseWriter, req *http.Request)
}
...
type APIHandler interface {
	...
	// secrets
	ListSecrets(ctx context.Context, body *model.ListSecretsRequest) (*model.ListSecretsResponse, error)
	GetSecret(ctx context.Context, key string) (*model.Secret, error)
	SetSecret(ctx context.Context, key string) (*model.Secret, error)
	// oauth
	ListOAuthProviders(ctx context.Context, body *model.ListOAuthProvidersRequest) (*model.ListOAuthProvidersResponse, error)
	GetOAuthAuthorizationURL(ctx context.Context, provider string) (*model.GetOAuthAuthorizationURLResponse, error)
	GetOAuthToken(ctx context.Context, provider string, body *model.GetOAuthTokenRequest) (*model.Token, error)
	GetOAuthConfig(ctx context.Context, provider string) (*model.Config, error)
	SetOAuthConfig(ctx context.Context, provider string) (*model.Config, error)
}
